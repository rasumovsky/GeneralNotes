...
This section provides notes on data structures and coding generally in C++. Table \ref{tab:cpp_structures} provides a description of some basic C++ data structures. 
