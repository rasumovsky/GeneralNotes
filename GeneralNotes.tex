...
\date{January 12, 2015} % An optional date to appear under the author(s)
...
%\input{Sections/InformationTheory.tex}
\input{Sections/DataStructures.tex}
%\input{Sections/NumericalMethods.tex}
%\input{Sections/MachineLearning.tex}
